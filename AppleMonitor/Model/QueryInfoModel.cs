...
namespace AppleMonitor.Model
{
    ...
    public partial class PickupMessage
    {
        ...
        [JsonProperty("warmDudeWithAPU")]
        public bool WarmDudeWithApu { get; set; }

        [JsonProperty("viewMoreHoursVoText")]
        public string ViewMoreHoursVoText { get; set; }

        [JsonProperty("availability")]
        public Availability Availability { get; set; }

        [JsonProperty("viewDetailsText")]
    ...
    public partial class Store
    {
        ...
        public Uri MakeReservationUrl { get; set; }

        [JsonProperty("state")]
        public string State { get; set; }

        [JsonProperty("storeImageUrl")]
        public Uri StoreImageUrl { get; set; }
        ...
        [JsonProperty("pickupOptionsDetails")]
        public PickupOptionsDetails PickupOptionsDetails { get; set; }
    ...
    {
        [JsonProperty("storePickEligible")]
        public bool StorePickEligible { get; set; }

        [JsonProperty("storeSearchEnabled")]
        ...
        [JsonProperty("storePickupQuote2_0")]
        public string StorePickupQuote20 { get; set; }

        [JsonProperty("pickupSearchQuote")]
        public string PickupSearchQuote { get; set; }

        [JsonProperty("storePickupLabel")]
        ...
        [JsonProperty("ctoOptions")]
        public string CtoOptions { get; set; }

        [JsonProperty("storePickupLinkText")]
    ...
    public partial class PickupOptionsDetails
    {
        [JsonProperty("whatToExpectAtPickup")]
        public string WhatToExpectAtPickup { get; set; }
    ...
    {
        [JsonProperty("pickupOptionTitle")]
        public string PickupOptionTitle { get; set; }
    ...
    public partial class RetailStore
    {
        ...
        [JsonProperty("storeTypeKey")]
        public string StoreTypeKey { get; set; }

        [JsonProperty("storeSubTypeKey")]
        public string StoreSubTypeKey { get; set; }
        ...
        [JsonProperty("address")]
        public RetailStoreAddress Address { get; set; }

        [JsonProperty("urlKey")]
        public object UrlKey { get; set; }

        [JsonProperty("directionsUrl")]
        public object DirectionsUrl { get; set; }
        ...
        [JsonProperty("hoursAndInfoUrl")]
        public Uri HoursAndInfoUrl { get; set; }

        [JsonProperty("storeHours")]
        public StoreHour[] StoreHours { get; set; }

        [JsonProperty("storeHolidays")]
        public StoreHoliday[] StoreHolidays { get; set; }

        [JsonProperty("secureStoreImageUrl")]
        public Uri SecureStoreImageUrl { get; set; }
        ...
        [JsonProperty("distanceWithUnit")]
        public string DistanceWithUnit { get; set; }

        [JsonProperty("timezone")]
        public string Timezone { get; set; }

        [JsonProperty("storeIsActive")]
        ...
        [JsonProperty("distanceSeparator")]
        public string DistanceSeparator { get; set; }

        [JsonProperty("nextAvailableDate")]
        public object NextAvailableDate { get; set; }
        ...
        public Data DynamicAttributes { get; set; }
        ...
        public object StoreTimings { get; set; }

        [JsonProperty("availableNow")]
        public bool AvailableNow { get; set; }
    }

    public partial class RetailStoreAddress
    {
        [JsonProperty("city")]
        public string City { get; set; }
        ...
        [JsonProperty("addrSourceType")]
        public object AddrSourceType { get; set; }

        [JsonProperty("outsideCityFlag")]
        public object OutsideCityFlag { get; set; }

        [JsonProperty("daytimePhoneAreaCode")]
        public object DaytimePhoneAreaCode { get; set; }

        [JsonProperty("eveningPhoneAreaCode")]
        public object EveningPhoneAreaCode { get; set; }

        [JsonProperty("daytimePhone")]
        public string DaytimePhone { get; set; }

        [JsonProperty("fullPhoneNumber")]
        public object FullPhoneNumber { get; set; }

        [JsonProperty("eveningPhone")]
        public object EveningPhone { get; set; }
        ...
        [JsonProperty("lastNamePhonetic")]
        public object LastNamePhonetic { get; set; }

        [JsonProperty("firstNamePhonetic")]
        ...
        public bool BusinessAddress { get; set; }
        ...
        public object MobilePhoneAreaCode { get; set; }

        [JsonProperty("cityStateZip")]
        public object CityStateZip { get; set; }

        [JsonProperty("daytimePhoneSelected")]
        public bool DaytimePhoneSelected { get; set; }

        [JsonProperty("middleName")]
        public object MiddleName { get; set; }

        [JsonProperty("residenceStatus")]
        public object ResidenceStatus { get; set; }
        ...
        [JsonProperty("fullEveningPhone")]
        public object FullEveningPhone { get; set; }

        [JsonProperty("fullDaytimePhone")]
        public string FullDaytimePhone { get; set; }

        [JsonProperty("correctionResult")]
        public object CorrectionResult { get; set; }

        [JsonProperty("twoLineAddress")]
        public string TwoLineAddress { get; set; }
    ...
    public partial class StoreHoliday
    {
        [JsonProperty("date")]
    ...
    public partial class StoreHour
    {
        ...
        [JsonProperty("voStoreDays")]
        public object VoStoreDays { get; set; }

        [JsonProperty("storeTimings")]
        public string StoreTimings { get; set; }
    }

    public partial class StorePickupMethodByType
    {
    ...
    public partial class Instore
    {
        ...
        [JsonProperty("typeCoordinate")]
        public TypeCoordinate TypeCoordinate { get; set; }

        [JsonProperty("typeDirection")]
        public TypeDirection TypeDirection { get; set; }

        [JsonProperty("typeMeetupLocation")]
        public TypeMeetupLocation TypeMeetupLocation { get; set; }
    }
    ...
    {
        [JsonProperty("directionByLocale")]
        public object DirectionByLocale { get; set; }
    }

    public partial class TypeMeetupLocation
    {
    ...
    {
        [JsonProperty("specialHoursText")]
        public string SpecialHoursText { get; set; }
        ...
        [JsonProperty("specialHoursData")]
        public SpecialHoursDatum[] SpecialHoursData { get; set; }

        [JsonProperty("viewAllSpecialHours")]
        public bool ViewAllSpecialHours { get; set; }
    }

    public partial class SpecialHoursDatum
    {
        [JsonProperty("specialDays")]
        public string SpecialDays { get; set; }

        [JsonProperty("specialTimings")]
        public string SpecialTimings { get; set; }
    }
